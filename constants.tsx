...
export const Icons = {
  Zap: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 14.71L12 2l1 9.53H20l-8 12.71-1-9.53H4z"/></svg>
  ),
  Layers: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.85a2 2 0 0 0 0 3.58L11.17 15.1a2 2 0 0 0 1.66 0l8.57-4.67a2 2 0 0 0 0-3.58Z"/><path d="m2.6 13.58 8.57 4.67a2 2 0 0 0 1.66 0l8.57-4.67"/><path d="m2.6 17.58 8.57 4.67a2 2 0 0 0 1.66 0l8.57-4.67"/></svg>
  ),
  Download: (props: any) => (
  ...
  // Added BarChart icon to resolve property error in App.tsx
  BarChart: (props: any) => (
